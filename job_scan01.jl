#=
This is an example code to calculate Hitmap and crosslink map.
$ julia job_scan01.jl N
Then, Tha hitmap and crosslink map will be calculated in N year.
=#
...
@time out_map = Mapmaking(NSIDE, N*year, smp_rate, dth, dph, "equator")

np.savez_compressed(format("./output/nside512_19Hz_bore_{}year_obs", N), out_map=out_map)
println("Finish!")
